      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-12 md:py-16 mt-16">
          <div className="space-y-6 text-center max-w-3xl mx-auto mb-8">
            <p className="text-sm dark:text-gray-300">About Me</p>
            ...
            <div className="flex justify-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-purple-100 dark:border-purple-900/40 shadow-md">
                <Image 
        ...
        {/* Career Path Section */}
        <section className="container mx-auto px-4 py-12 bg-gray-50 dark:bg-gray-800/50">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold mb-8 text-center dark:text-white">My Path: From Discovery to Development</h2>
            ...
            <div className="space-y-16">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-5 gap-4">
                <div className="md:col-span-2 flex md:justify-end">
                  <div className="max-w-xs">
                    <h3 className="font-semibold text-xl mb-2 dark:text-white">Research Foundations</h3>
                ...
                <div className="hidden md:flex justify-center items-start">
                  <div className="w-1 bg-purple-200 dark:bg-purple-700 h-full"></div>
                  <div className="absolute top-0 w-4 h-4 rounded-full bg-purple-400 dark:bg-purple-500 transform -translate-x-1/2"></div>
                </div>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div className="md:col-span-2">
                  <div className="max-w-xs">
                    <h3 className="font-semibold text-xl mb-2 dark:text-white">Academic Exploration</h3>
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-5 gap-4">
                <div className="md:col-span-2 flex md:justify-end">
                  <div className="max-w-xs">
                    <h3 className="font-semibold text-xl mb-2 dark:text-white">Entrepreneurial Ventures</h3>
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div className="md:col-span-2">
                  <div className="max-w-xs">
                    <h3 className="font-semibold text-xl mb-2 dark:text-white">Strategic Partnerships</h3>
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/30 rounded-lg p-8 relative border border-purple-200 dark:border-purple-800 shadow-sm">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">My Driving Force</h2>
        ...
        <section className="container mx-auto px-4 py-12 bg-gray-50 dark:bg-gray-800/50">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl font-bold mb-4 dark:text-white">Let's Connect</h2>
            ...
            <div className="flex justify-center gap-4 mb-8">
              <a href="#" className="bg-white dark:bg-gray-700 p-3 rounded-full shadow-md hover:shadow-lg transition-all">
